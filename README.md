...
- 障害物 0.13 m 以内への接近ゼロ、衝突ゼロ(最悪 0.139 m。標準 3 controller は成功 episode でも
  数 cm の掠りが発生)
...
27.6 秒でした（DWB 27.9 秒 (49/54 成功・衝突 1、ただし 168 秒の復帰動作 1 件に引っ張られた値で
中央値は 25.2 秒)、MPPI 29.0 秒 (51/54)、RPP 24.2 秒 (48/54)。
