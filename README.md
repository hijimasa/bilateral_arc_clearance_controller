...
- 自己位置ズレ 0.10〜0.25 m の 1.5 m 通路で**到達時間もクリアランスも不変**(全域 28.8 s / 0.23)。
  同じ 0.25 m で DWB は衝突または 0.01 m の擦過、RPP は中断し、プランナ側のマージン対策でも
  「依然衝突」か「計画不能」にしかならない
...
27.7 秒でした（DWB 25.1 秒 (50/54 成功・衝突 1)、MPPI 29.4 秒 (51/54)、RPP 24.2 秒 (48/54)。
